...
\begin{frame}{Results and Outlook}
  ...
  \item \BF(\decay{\Bd}{\proton \antiproton})$ = (1.25\pm0.27\pm0.18) \times 10^{-8}$ - Rarest hadronic decay of a \Bd meson ever observed!
...
\begin{frame}
  \begin{block}{}
    \centering \Huge Search for CP violation in \decay{\PXi_{b}^{-}}{\proton \Km \Km} decays.
  \end{block}
\end{frame}

\begin{frame}{Overview}
  \begin{itemize}
  \item \decay{\PXi_{b}^{-}}{\proton \Km \Km} was observed for the first time using Run I data [Phys. Rev. Lett. 118, 071801].
...
\begin{frame}{\decay{\PXi_{b}^{-}}{\proton \Km \Km} Run I improvements}
  \small
...
\begin{frame}{CPV in \decay{\Lb/\PXi_{b}^{0}}{\proton h h h}}
  \begin{block}{}
    \begin{center}
      \Huge CPV in \decay{\Lb/\PXi_{b}^{0}}{\proton h h h}
    \end{center}
  \end{block}
\end{frame}
...
\begin{frame}{Summary of \decay{\Lb/\PXi_{b}^{0}}{\proton h h h} CPV searches}
  \begin{itemize}
  ...
  \item Run I results for \decay{\Lb}{\proton \Km \pip \pim}, \decay{\Lb}{\proton \Km \Kp \Km} and \decay{\PXi_{b}^{0}}{\proton \pip \Km \Km} decays still blind and in review comittee.
  ...
  \item Further analyses aiming to measure \ACP and BFs for \decay{\Lb}{\proton hhh} decays are well advanced in the RC.
  \end{itemize}
\end{frame}
...
\begin{frame}{Conclusions}
  ...
  \item Many more analyses using Run II data in preperation e.g:
    ...
    \item \decay{\Bs}{\KS \KS}
    \item TD CPV in \decay{\PB^{0}_{(s)}}{hh} decays
    \item CPV in \decay{\Lb}{\KS \proton h}
    \item \decay{\PB}{3h} BFs
    \end{itemize}
